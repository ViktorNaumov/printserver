...
module.exports.DxfCreator = function (type, param,func) {
  switch (type) {
    case "rec":
      let rec_start = fs
      ...
      func(rec_body_start + rec_body_string + rec_body_end);
    ...
    case "cir":
      ...
      func(cir_body_start + cir_body_string + cir_body_end);
      break;
    case "tri":
      let tri_start = fs
      ...
      func(tri_body_start + tri_body_string + tri_body_end);
      break;
    case "was":
      let was_start = fs
      ...
      func(was_body_start + was_body_string + was_body_end);
      break;
    case "sec":
      ...
      func(sec_body_start + sec_body_string + sec_body_end);
      break;
  }
};
